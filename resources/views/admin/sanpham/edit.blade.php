...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-12" style="padding-bottom:120px">
            ...
            <form action="{{ route('SanPham_edit',[$sp->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group{{ $errors->has('catalog') ? ' has-error' : '' }} row">
                  ...
                  <div class="col-sm-9">  
                    {!! Form::select('catalog', $dscatalog->pluck('name','id'), $sp->id_catalog, ['id' => 'catalog', 'class' => 'form-control', 'required' => 'required', ]) !!}
               ...
               <div class="form-group{{ $errors->has('ten') ? ' has-error' : '' }} row">
                 ...
                 <div class="col-sm-9">
                     {!! Form::text('ten', $sp->ten, ['class' => 'form-control', 'required' => 'required']) !!}
                ...
                <div class="form-group{{ $errors->has('quycach') ? ' has-error' : '' }} row">
                  ...
                  <div class="col-sm-9">
                      {!! Form::text('quycach', $sp->quycach, ['class' => 'form-control', ]) !!}
                ...
                <div class="form-group{{ $errors->has('chatluong') ? ' has-error' : '' }} row">
                  ...
                  <div class="col-sm-9">
                      {!! Form::text('chatluong', $sp->chatluong, ['class' => 'form-control', ]) !!}
                ...
                <div class="form-group{{ $errors->has('congdung') ? ' has-error' : '' }} row">
                  ...
                  <div class="col-sm-9">
                      {!! Form::text('congdung', $sp->congdung, ['class' => 'form-control', ]) !!}
                ...
                <div class="form-group{{ $errors->has('nanglucdapung') ? ' has-error' : '' }} row">
                  ...
                  <div class="col-sm-9">
                      {!! Form::text('nanglucdapung', $sp->nanglucdapung, ['class' => 'form-control', ]) !!}
                ...
                <div class="form-group{{ $errors->has('gia') ? ' has-error' : '' }} row">
                    ...
                    <div class="col-sm-9">
                      {!! Form::number('gia', $sp->gia, ['class' => 'form-control', ]) !!}
                ...
                <div class="form-group{{ $errors->has('mota') ? ' has-error' : '' }} row">
                    ...
                    <div class="col-sm-9">
                      {!! Form::textarea('mota', $sp->mota, ['class' => 'form-control ckeditor', ]) !!}
