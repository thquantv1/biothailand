...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-lg-12" style="padding-bottom:120px">
            ...
            <form action="{{ route('CuaHang_add') }}" method="POST" enctype="multipart/form-data">
               ...
               <div class="form-group{{ $errors->has('stt') ? ' has-error' : '' }} row">
                   ...
                   <div class="col-sm-9">
                       {!! Form::number('stt', null, ['class' => 'form-control', 'required' => 'required','min'=>1,'max'=>999]) !!}
              ...
              <div class="radio{{ $errors->has('loai') ? ' has-error' : '' }} form-group row">
                <div class="control-label col-sm-3">
                  ...
                  <div class="col-sm-offset-3 col-sm-9">
                      <label for="loai">
                          {!! Form::radio('loai', 1, null, ['id' => 'loai']) !!} Cửa Hàng Chính
                          {!! Form::radio('loai', 2, 1, ['id' => 'loai']) !!} Cửa Hàng Nhượng Quyền
                      </label>
                ...
                <div class="form-group{{ $errors->has('diachi') ? ' has-error' : '' }} row">
                    ...
                    <div class="col-sm-9">
                        {!! Form::text('diachi', null, ['class' => 'form-control', 'required' => 'required']) !!}
                ...
                <div class="form-group{{ $errors->has('sdt') ? ' has-error' : '' }} row">
                    ...
                    <div class="col-sm-9">
                        {!! Form::text('sdt', null, ['class' => 'form-control', 'required' => 'required']) !!}
                ...
                <div class="form-group{{ $errors->has('tinhthanhpho') ? ' has-error' : '' }} row">
                    ...
                    <div class="col-sm-9">
                        {!! Form::select('tinhthanhpho', $dstinhthanh->sortBy('name')->pluck('name','matp'), null, ['id' => 'tinhthanhpho', 'class' => 'form-control', 'required' => 'required']) !!}
                ...
                <div class="form-group row {{ $errors->has('maqh') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <div id="loadqh">
                            {!! Form::select('maqh',[0=>"Chọn tỉnh/Thành phố trước"], null, ['id' => 'maqh', 'class' => 'form-control', 'required' => 'required', 'disabled']) !!}
                        </div>                        
                ...
                <div class="form-group{{ $errors->has('tthd') ? ' has-error' : '' }} row">
                    ...
                    <div class="col-sm-9">
                        {!! Form::select('tthd',tinhtranghd(), null, ['id' => 'tthd', 'class' => 'form-control', 'required' => 'required']) !!}
                ...
                <div class="form-group{{ $errors->has('thongtin') ? ' has-error' : '' }} row">
                    ...
                    <div class="col-sm-9">
                        {!! Form::textarea('thongtin', null, ['class' => 'form-control ckeditor', 'required' => 'required']) !!}
