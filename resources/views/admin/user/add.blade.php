    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12" style="padding-bottom:120px">
                ...
                <form action="{{ route('ThanhVien_add') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group{{ $errors->has('chucvu') ? ' has-error' : '' }} row">
                        ...
                        <div class="col-sm-9">
                            {!! Form::text('chucvu', null, ['class' => 'form-control', 'required' => 'required']) !!}
                    ...
                    <div class="form-group{{ $errors->has('thongtin') ? ' has-error' : '' }} row">
                        ...
                        <div class="col-sm-9">
                            {!! Form::text('thongtin', null, ['class' => 'form-control', 'required' => 'required']) !!}
                    ...
                    <div class="form-group{{ $errors->has('twlink') ? ' has-error' : '' }} row">
                        ...
                        <div class="col-sm-9">
                            {!! Form::text('twlink', null, ['class' => 'form-control']) !!}
                    ...
                    <div class="form-group{{ $errors->has('iglink') ? ' has-error' : '' }} row">
                        ...
                        <div class="col-sm-9">
                            {!! Form::text('iglink', null, ['class' => 'form-control']) !!}
