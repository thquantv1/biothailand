    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12" style="padding-bottom:120px">
                ...
                <form action="{{ route('Story_edit',[$st->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group{{ $errors->has('thoigian') ? ' has-error' : '' }} row " >
                        ...
                        <div class="col-sm-9">
                            {!! Form::date('thoigian', $st->thoigian, ['class' => 'form-control', 'required' => 'required']) !!}
                    ...
                    <div class="form-group{{ $errors->has('tieude') ? ' has-error' : '' }} row">
                        ...
                        <div class="col-sm-9">
                            {!! Form::text('tieude', $st->tieude, ['class' => 'form-control', 'required' => 'required']) !!}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          ...
                          @if ($st->hinh!="")
                              src="{{ asset('upload/story/'.$st->hinh) }}"
                          @endif
                            >
                        </div>
                    </div>
                    ...
                    <div class="form-group{{ $errors->has('sukien') ? ' has-error' : '' }} row">
                       ...
                       <div class="col-sm-9">
                           {!! Form::text('sukien', $st->sukien, ['class' => 'form-control', 'required' => 'required']) !!}
