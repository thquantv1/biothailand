...
<div id="page-wrapper">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Deep setting -
                    <small>Add</small>
                </h1>
            </div>
            <!-- /.col-lg-12 -->
            ...
            @endif
                <form action="{{ route('setting_add') }}" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
                    <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                    <div class="form-group">
                        <label>Key Name</label>
                        <input class="form-control" name="keyname" placeholder="Input key name" />
                    </div>
                    <div class="form-group{{ $errors->has('value') ? ' has-error' : '' }}">
                        ...
                        {!! Form::textarea('value', null, ['class' => 'form-control','placeholder'=>'Input value','id'=>'value']) !!}
                    ...
                    <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('description', null, ['class' => 'form-control','placeholder'=>'desciption for field']) !!}
